...
src_install() {
  ...
  fperms 755 "${dir}"/plugins/r-plugin/{fsnotifier-linux,fsnotifier-linux-aarch64,fsnotifier-osx,fsnotifier-windows.exe,rwrapper-arm64-linux,rwrapper-arm64-osx,rwrapper-x64-linux,rwrapper-x64-osx,rwrapper-x64-windows.exe}
